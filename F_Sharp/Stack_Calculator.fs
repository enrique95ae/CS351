//================================================
//Complete Koans and Submit as a HW (10pt in total)
...
let stackWith2test = push 2.0 emptyStack
printf "T2... (should be enough by switching the order in which elements are pushed into the stack.)..."
