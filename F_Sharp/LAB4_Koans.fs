...
---------------------------
 ...
 not(x2 % 2 = 0)
 let original2 = [0..5]
 let result12, result22 = List.partition isOdd2
original2
 AssertEquality result12 [1;3;5]
AssertEquality result22 [0;2;4]
 //-----------------------------------------------------
----------
 // Note: There are many other useful methods in the
List module. //Check them
// via intellisense in Visual Studio by typing '.'
after List, or online at
...
----------
 ...
 //
// The forward pipe operator is one of the most
commonly used
// symbols in F# programming. You can use it combine
operations
// on lists and other data structures in a readable
way.
//-----------------------------------------------------
----------
...
-----------
 ...
 let isEven3 x3 =
 x3 % 2 = 0
 //One way to combine operations is by using separate
statements.
// However, this is can be clumsy since you have to
name each result.
  let numbers3 = [0..5]
...
-------------------------
 //You can avoid this problem by using parens to pass
the result of one
// funciton to another. This can be difficult to read
since you //have to
// start from the innermost function and work your
way out.
   let numbers4 = [0..5]
AssertEquality result4 [0;4;16]
 let result4 = List.map square3 (List.filter isEven3
numbers4)
  //-----------------------------------------------------
----------
 // ---- square even numbers with  the pipeline operator
---------
 //In F#, you can use the pipeline operator to get the
benefit of the
 //  parens style with the readablity of the statement
...
----------
 ...
 //
// Like lists, arrays are another basic container type
in F#.
//-----------------------------------------------------
----------
   // ---- creating arrays
